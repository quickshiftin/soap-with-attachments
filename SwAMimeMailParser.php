 ...
 *
 * Mail Parse extension http://pecl.php.net/package/mailparse
 * 
...
class SwAMimeMailParser {
     ...
     * @return Object SwAMimeMailParser Instance
    ...
    public function getHeaders() {
        if (isset($this->parts[1])) {
            ...
            throw new Exception('SwAMimeMailParser::setPath() or SwAMimeMailParser::setText() must be called before retrieving email headers.');
        }
        return false;
    }
    /**
    ...
    public function getMessageBody($type = 'text') {
        ...
        // @note I wonder if the interface might be cleaner if we allow a mime type as a parameter
        //       instead of some variation, of one, of a subset of mime types...
        //       The need for xml came through decoding MIME documents sent via SOAP libraries
        //       (@see SwASoapClient).  Maybe there are more scenarios supporting the quandry....
        $mime_types = array(
            'text' => 'text/plain',
            'html' => 'text/html',
            'xml'  => 'text/xml',
        ...
        if (in_array($type, array_keys($mime_types))) {
            ...
            throw new Exception('Invalid type specified for SwAMimeMailParser::getMessageBody. "type" can either be text or html.');
        }
        return $body;
    }
    ...
    public function getAttachments() {
        ...
        foreach($this->parts as $part) {
            ...
            if (in_array($disposition, $dispositions) === TRUE
                ...
                $attachments[] = new SwAMimeMailParserAttachment(
    ...
    private function getPartHeaderRaw(&$part) {
        ...
        if ($this->stream) {
            ...
            throw new Exception('SwAMimeMailParser::setPath() or SwAMimeMailParser::setText() must be called before retrieving email parts.');
        }
        return $header;
    }
    /**
